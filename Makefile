all : exec/BAT_builder.x exec/PARENT.x exec/get_PAR_MIST.x analysis
...
obj/io_binary.o : src/util/io/io_binary.cpp | obj
	g++ -c src/util/io/io_binary.cpp -o obj/io_binary.o $(COPS)

obj/io_text.o : src/util/io/io_text.cpp | obj
...
obj/util.o : src/util/util.cpp | obj
...
exec/BAT_builder.x : src/util/io/xdrfile/xdrfile.c src/util/io/xdrfile/xdrfile_xtc.c src/BAT_builder/bat.cpp src/BAT_builder/bat.h src/BAT_builder/topology.cpp src/BAT_builder/BAT_topology.cpp src/BAT_builder/BAT_trajectory.cpp obj/io.o | obj exec
...
exec/PARENT.x : src/PARENT/PARENT.cpp obj/io.o | exec
...
exec/get_PAR_MIE.x : src/process_output/get_PAR_MIE.cpp obj/io.o | obj/util.o exec
