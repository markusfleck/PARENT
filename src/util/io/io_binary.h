...
int write_PAR_body(ofstream* par_file, int nDihedrals,double* bondsEntropy1D, double* anglesEntropy1D, double* dihedralsEntropy1D, double* bbEntropy, double* aaEntropy, double* ddEntropy, double* baEntropy, double* bdEntropy, double* adEntropy);
